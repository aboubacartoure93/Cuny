/** simple chat bewtwen student with books involve
 * Chat logic
 *
...
var ready = function () {
    ...
    chatBox2 = {
        ...
        chatWith: function (conversation_id) {
            ...
            chatBox2.createChatBox(conversation_id);
        ...
        createChatBox2: function (conversation_id, book_id, minimizeChatBox) {
