...
var chatboxFocusSimple = new Array();
var chatBoxesSimple = new Array();

var readySimple = function () {
    ...
    chatBoxS = {
        ...
        chatWith: function (conversation_id) {
            ...
            chatBoxS.createChatBox(conversation_id);
        ...
        restructure: function () {
            align = 0;
            for (x in chatBoxesSimple) {
                chatbox_id = chatBoxesSimple[x];
        ...
        createChatBox: function (conversation_id, book_id, minimizeChatBox) {
            ...
            for (x in chatBoxesSimple) {
                if ($("#chatbox_" + chatBoxesSimple[x]).css('display') != 'none') {
                    chatBoxeslength++;
                }
            }
            ...
            chatBoxesSimple.push(conversation_id);
            ...
            chatboxFocusSimple[conversation_id] = false;
            ...
            $("#chatbox_" + conversation_id + " .chatboxtextarea").blur(function () {
                ...
                chatboxFocusSimple[conversation_id] = true;
...
$(document).ready(readySimple);
$(document).on("page:load", readySimple);
...
var ready = function () {
    ...
    chatBox = {
        ...
        createChatBox: function (conversation_id, book_id, minimizeChatBox) {
            ...
            $.get("books" + book_id + "/conversations/" + conversation_id, function (data) {
                $('#chatbox_' + conversation_id).html(data);
                $("#chatbox_" + conversation_id + " .chatboxcontent").scrollTop($("#chatbox_" + conversation_id + " .chatboxcontent")[0].scrollHeight);
            }, "html");
...
var ready = function () {
   ...
   $('.start-conversationSimple').click(function (e) {
        ...
        $.post("/conversations", { sender_id: sender_id, recipient_id: recipient_id }, function (data) {
            chatBoxS.chatWith(data.conversation_id);
        });
    });
